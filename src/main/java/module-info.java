module no.ntnu.mathieno.inventorymanager {
    ...
    exports no.ntnu.mathieno.inventorymanager.backend.controllers to javafx.fxml;
    opens no.ntnu.mathieno.inventorymanager.backend.controllers to javafx.fxml;
